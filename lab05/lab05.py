...
def distance(city1, city2):
    ...
    5.0
    """
    city1_lat, city1_lon = get_lat(city1), get_lon(city1)
    city2_lat, city2_lon = get_lat(city2), get_lon(city2)
    distance = sqrt((city1_lat - city2_lat) ** 2 + (city1_lon - city2_lon) ** 2)
    return distance
    ...
    1
      2
        3
          ...
          2
    """
    value_tree = [tree(i) for i in vals]
    if is_leaf(t):
        return tree(label(t), value_tree)

    else: 
        new_branches = [sprout_leaves(i, vals) for i in branches(t)]
